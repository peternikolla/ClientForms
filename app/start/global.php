...
Form::macro('textField', function($name, $label = null, $required = false, $value = null, $attributes = array())
{
	$element = Form::text($name, $value, fieldAttributes($name, $attributes));

	return fieldWrapper($name, $label, $element, $required);
});

Form::macro('passwordField', function($name, $label = null, $required = false, $attributes = array())
{
...
Form::macro('textareaField', function($name, $label = null,  $required = false, $value = null, $attributes = array())
{
...
Form::macro('selectField', function($name, $label = null, $required = false, $options, $value = null, $attributes = array())
{
...
Form::macro('selectMultipleField', function($name, $label = null, $required = false, $options, $value = null, $attributes = array())
{
...
function fieldWrapper($name, $label, $element, $required=false)
{
	$out = '<div class="form-group';
	$out .= fieldError($name) . '">';
	$out .= fieldLabel($name, $label, $required);
	$out .= $element;
	$out .= '</div>';
